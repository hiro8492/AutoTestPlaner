# ============================================================
#  Ollama + Qwen3 (4B / 8B) Installer for Windows
...
# ── 4. Pull Qwen3 models ────────────────────────────────────
Write-Step "Downloading Qwen3 models"

$models = @(
    @{ Tag = "qwen3:4b";  Desc = "Qwen3 4B (approx 2.6 GB)";  MinRAM = 8 },
    @{ Tag = "qwen3:8b";  Desc = "Qwen3 8B (approx 4.9 GB)";  MinRAM = 12 }
)
